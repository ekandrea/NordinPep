export const products = [
  {
    ...
    slug: 'bpc-157',
    name: 'BPC-157',
    subtitle: 'Bra reagens för att studera vävnadsreparation i labb',
    price: 449,
  ...
  },
  {
    ...
    slug: 'selank',
    name: 'Selank',
    subtitle: 'Bra reagens för att studera signalsubstanser i labb',
    price: 399,
  ...
  },
  {
    ...
    slug: 'ghk-cu',
    name: 'GHK-Cu',
    subtitle: 'Bra reagens för att studera hud och celler i labb',
    price: 379,
    category: 'Anti-Aging',
    popular: true,
    specs: {
  ...
  },
  {
    ...
    slug: 'epithalon',
    name: 'Epithalon',
    subtitle: 'Bra reagens för att studera cellulär åldrande i labb',
    price: 469,
    category: 'Anti-Aging',
    popular: false,
    specs: {
  ...
  },
  {
    ...
    subtitle: 'Bra reagens för att blanda forskningsreagenser i labb',
    price: 99,
    category: 'Tillbehör',
    popular: false,
    specs: {
  ...
  },
  {
    ...
    name: 'Sprayflask-kit',
    subtitle: 'Laboratorieutrustning för lösningshantering',
    price: 149,
    category: 'Tillbehör',
    popular: false,
    specs: {
